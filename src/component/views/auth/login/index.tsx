    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
            <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md grid gap-2">
                <h1 className="text-2xl font-bold text-center text-gray-700 mb-4">Sign In</h1>
                ...
                <p className="mt-2 text-sm text-center text-gray-600">Don{"'"}t have an account? {' '}
                    <Link href="/auth/register" className="text-blue-600 hover:underline">{isLoading ? "..." : "Sign In"}</Link>
                </p>
            </div>
        </div>
    );
